...
/**
 * ResourcesServiceV3 implements the gRPC ResourcesServiceServer.
 *
 ...
 */
type ResourcesServiceV3 struct {
 ...
 */
func (s *ResourcesServiceV3) GetSystemResources(
	ctx context.Context,
...
func (s *ResourcesServiceV3) ProcessAction(
	ctx context.Context,
...
func (s *ResourcesServiceV3) GetCpu(
	...
	snap, err := resources.GetCompleteSystemResources()
	if err != nil {
		return nil, status.Errorf(codes.Internal, "cpu snapshot failed: %v", err)
	}

	return &proto.GetCpuReply{
		Cpu: mapCPU(snap.CPU),
	}, nil
}

func (s *ResourcesServiceV3) GetMemory(
	ctx context.Context,
	_ *proto.GetMemoryRequest,
) (*proto.GetMemoryReply, error) {
	...
	snap, err := resources.GetCompleteSystemResources()
	if err != nil {
		return nil, status.Errorf(codes.Internal, "memory snapshot failed: %v", err)
	}

	return &proto.GetMemoryReply{
		Memory: mapMemory(snap.Memory),
	}, nil
}

func (s *ResourcesServiceV3) GetDevice(
	ctx context.Context,
	_ *proto.GetDeviceRequest,
) (*proto.GetDeviceReply, error) {
	...
	snap, err := resources.GetCompleteSystemResources()
	if err != nil {
		return nil, status.Errorf(codes.Internal, "device snapshot failed: %v", err)
	}

	return &proto.GetDeviceReply{
		Device: mapDevice(snap.Device),
	}, nil
}

func (s *ResourcesServiceV3) GetDisks(
	ctx context.Context,
	_ *proto.GetDisksRequest,
) (*proto.GetDisksReply, error) {
	...
	snap, err := resources.GetCompleteSystemResources()
	if err != nil {
		return nil, status.Errorf(codes.Internal, "disk snapshot failed: %v", err)
	}

	return &proto.GetDisksReply{
		Disks: mapDisks(snap.Disks),
	}, nil
}

func (s *ResourcesServiceV3) GetProcesses(
	ctx context.Context,
	_ *proto.GetProcessesRequest,
) (*proto.GetProcessesReply, error) {
	...
	snap, err := resources.GetCompleteSystemResources()
	if err != nil {
		return nil, status.Errorf(codes.Internal, "process snapshot failed: %v", err)
	}

	return &proto.GetProcessesReply{
		Processes: mapProcesses(snap.Procs),
	}, nil
}
...
func mapFileSystems(fs []cgo.FileSystem) []*proto.FileSystem {
	...
	out := make([]*proto.FileSystem, 0, len(fs))
